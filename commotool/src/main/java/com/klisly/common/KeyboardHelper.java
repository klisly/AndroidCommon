...
public final class KeyboardHelper {
     ...
     * Shortcat for {@link #hideSoftKeyboard(Context, View...) hideSoftKeyboard(activity,
     ...
     * Note: In AndroidManifest corresponding activity should have <code>android:windowSoftInputMode</code> set to
     * <code>adjustResize</code>.
     *
